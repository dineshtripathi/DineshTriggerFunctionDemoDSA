...
namespace Apprenticeship.AzureStorage.Queue.Tests
{
    public class QueueStorageAsyncTests : IDisposable
    {
        private const string QueueName = "sfaapprenticeshipTest-queue";
        private const string ConnectionString = "sfaStorage=true";
